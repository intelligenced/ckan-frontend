<x-guest-layout>
    <div class="flex">
        ...
        <main class="flex-1 p-6">
            <h1 class="text-2xl font-semibold mb-4">Datasets</h1>
            @foreach($datasets as $dataset)
                <div class="bg-white p-6 rounded-lg shadow-lg mb-4">
                    ...
                    <a href="{{ route('frontpage.data', ['id' => $dataset['id']]) }}" class="inline-block text-teal-600 hover:text-teal-800 hover:underline">View Dataset</a>
                </div>
            @endforeach
        </main>
    </div>
